<div class="modal-dialog">
  <div class="modal-content">
    ...
    <div class="modal-body">
      <form action="{{ route('admin.Master.difficultylevel.store', Crypt::encrypt($rs_records[0]->id)) }}" method="post" class="add_form" content-refresh="example2" button-click="btn_close">
            {{ csrf_field() }}
            <div class="row">
