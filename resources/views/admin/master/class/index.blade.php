...
<section class="content-header">
    <div class="container-fluid">
        ...
        <div class="card card-info"> 
            <div class="card-body"> 
                <form action="{{ route('admin.Master.class.store', Crypt::encrypt(0)) }}" method="post" class="add_form" content-refresh="example2">
                    {{ csrf_field() }}
                    <div class="row">
                                 ...
                                 <tbody>
                                    ...
                                    @foreach ($rs_records as $rs_value)
                                        <tr>
                                            ...
                                            <td>
                                                <a type="button" onclick="callPopupLarge(this,'{{ route('admin.Master.class.edit', Crypt::encrypt($rs_value->id)) }}')" title="" class="btn btn-info btn-sm"><i class="fa fa-edit"></i> Edit</a>
                                                <a type="button" href="{{ route('admin.Master.class.delete',Crypt::encrypt($rs_value->id)) }}" onclick="return confirm('Are you sure you want to delete this item?');" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> Delete</a>
                                            </td>
                                        </tr> 
                                    @endforeach
                                </tbody>
